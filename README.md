...
Saved, trained regressor models are available in [tools/resources](https://github.com/evanmacbride/microscope-autofocus/tree/main/tools/resources). A quick demo of loading saved models to perform regression tasks (load_saved_demo.py) is available in [tools](https://github.com/evanmacbride/microscope-autofocus/tree/main/tools).
